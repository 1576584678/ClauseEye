...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    name: '二手房买卖',
    short: '二手房',
    description: '二手房买卖合同、居间协议、定金/网签材料',
    rulePack: 'house',
  },
  {
    code: 'decoration',
...
const KEYWORDS: Record<Exclude<CategoryCode, 'other'>, KeywordRule[]> = {
  ...
  house: [
    { pattern: /二手房|存量房|房屋买卖合同/g, weight: 4, label: '二手房买卖' },
    { pattern: /不动产登记|房屋过户|权属转移/g, weight: 3, label: '过户登记' },
    { pattern: /出卖人|卖方|买受人|买方/g, weight: 2, label: '买卖双方' },
    { pattern: /定金|首付款|购房款|房款/g, weight: 3, label: '房款/定金' },
    { pattern: /居间|中介费|佣金/g, weight: 2, label: '中介居间' },
    { pattern: /户口|落户|迁出/g, weight: 2, label: '户口' },
    { pattern: /建筑面积|套内面积|房屋面积/g, weight: 2, label: '面积' },
    { pattern: /交房|交付房屋|验收房屋/g, weight: 2, label: '交房' },
    { pattern: /学区|学位/g, weight: 2, label: '学区' },
    { pattern: /抵押|查封/g, weight: 2, label: '抵押/查封' },
  ],
  decoration: [
    { pattern: /装修|装饰装修|家装/g, weight: 4, label: '装修' },
    { pattern: /装修公司|装饰公司|施工方|承包方/g, weight: 3, label: '施工方' },
    { pattern: /隐蔽工程|水电改造|防水/g, weight: 3, label: '隐蔽工程' },
    { pattern: /主材|辅材|板材|乳胶漆|瓷砖/g, weight: 2, label: '材料' },
    { pattern: /增项|变更项目|追加项目/g, weight: 3, label: '增项' },
    { pattern: /工期|开工|竣工/g, weight: 2, label: '工期' },
    { pattern: /验收|质量验收/g, weight: 2, label: '验收' },
    { pattern: /甲醛|环保检测|空气质量/g, weight: 2, label: '环保' },
    { pattern: /尾款|质保金|保修期/g, weight: 2, label: '尾款/保修' },
    { pattern: /设计图|施工图|效果图/g, weight: 2, label: '图纸' },
  ],
  driving: [
    { pattern: /驾校|机动车驾驶培训|驾驶培训/g, weight: 5, label: '驾校/驾驶培训' },
    { pattern: /教练员|教练/g, weight: 3, label: '教练' },
    { pattern: /学员|培训费|学费/g, weight: 3, label: '学员/学费' },
    { pattern: /科目一|科目二|科目三|科目四/g, weight: 3, label: '考试科目' },
    { pattern: /学时|课时|约车/g, weight: 3, label: '学时' },
    { pattern: /补考|复训|加练/g, weight: 2, label: '补考/复训' },
    { pattern: /准驾车型|\bC[12]\b/g, weight: 2, label: '准驾车型' },
    { pattern: /退学|转学|退费/g, weight: 3, label: '退学/退费' },
    { pattern: /教练车|训练场/g, weight: 2, label: '教练车/场地' },
  ],
}
