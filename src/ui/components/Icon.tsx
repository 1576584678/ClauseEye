...
/**
 * 统一图标集（内联 SVG，24×24 网格，stroke=currentColor）。
 * 约定：不使用 emoji 作图标；装饰性图标对无障碍树隐藏（aria-hidden）。
 */
...
const PATHS: Record<IconName, ReactNode> = {
  ...
  'alert-triangle': (
    <>
      <path d="M10.3 4.3 2.6 17.8a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z" />
      <path d="M12 9.5v4" />
      <path d="M12 17h.01" />
    </>
  ),
